...
//         }
        ...
        stage('report') {
            steps {
                ...
                recordIssues enabledForFailure: true, tool: phpStan(), qualityGates: [[threshold: 10, type: 'TOTAL', unstable: true]], healthy: 10, unhealthy: 100, minimumSeverity: 'HIGH', pattern: './reports/phpstan/phpstan.xml'
            }
        }
        stage('Documentation') {
            steps {
